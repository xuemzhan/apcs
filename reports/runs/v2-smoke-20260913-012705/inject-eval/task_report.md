...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-09-13T01:32:11.144116
...
{
  "n_samples": 30,
  "n_capability_records": 150,
  "zero_prefill_verified": true,
  "protocol_version": "1.1",
  "git_hash": "ef7282d81d39998673b7b24a0aee5e1cb954de5d",
  "online": false,
  ...
  "method_stats": {
    "ridge_kv_both": {
      ...
      "gold_prob_mean": 0.2333504348225891,
      "conf_mean": 0.9550483873077528,
      "ppl_mean": 6966.112079745168,
      "logit_cos_mean": 0.2330711750199616
    },
    "ridge_self_kv": {
      "total": 30,
      "accuracy": 0.5,
  ...
  "chg_gold": {
    "ridge_kv_both": {
      "mean": -0.2696085015420345,
      "ci_low": -0.5058317088469868,
      "ci_high": -0.01938827868841409,
      "p": 0.971028971028971,
      "n": 30,
      "tgrr": -1.4154839835554218
    },
    "ridge_self_kv": {
  ...
  "psr": {
    "mean": -3.600290244585959,
    "median": -2.938910682134236,
    "n": 30,
  ...
  "kv_norm_diagnostics": {
    ...
    "V": {
      ...
      "ratio_mean": 7.853672981262207
    }
  },
  "method_means": {
    "ridge_kv_both": 0.9550483873077528,
  ...
  "ppl_means": {
    "ridge_kv_both": 6966.112079745168,
    "ridge_self_kv": 21.226648495205207,
    "student": 25.35546443570249
  },
  "chg": 0.0978101577617948,
  "ridge_kv_both_score_mean": 0.9550483873077528,
