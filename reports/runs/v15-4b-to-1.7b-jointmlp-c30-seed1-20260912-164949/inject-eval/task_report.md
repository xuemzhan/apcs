...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-09-12T16:51:40.106253
...
```json
{
  ...
  "method_stats": {
    "ridge_kv_both": {
      ...
      "gold_prob_mean": 0.22237679099144167,
      "conf_mean": 0.7623138478778037,
      "ppl_mean": 27.58813752914416,
      "logit_cos_mean": 0.6286264030375163
    },
    "ridge_native": {
      "total": 30,
      "accuracy": 0.16666666666666666,
  ...
  "chg_gold": {
    "ridge_kv_both": {
      "mean": -0.2805821453731818,
      "ci_low": -0.443890359630866,
      "ci_high": -0.1098154262382996,
      "p": 1.0,
      "n": 30,
      "tgrr": -1.473097215316992
    },
    "ridge_native": {
  ...
  "psr": {
    "mean": -4.569138104061751,
    "median": -3.9329584764291248,
    "n": 30,
  ...
  "method_means": {
    "ridge_kv_both": 0.7623138478778037,
  ...
  "ppl_means": {
    "ridge_kv_both": 27.58813752914416,
    "ridge_native": 536082.490463978,
    "ridge_self_kv": 21.226648495205207,
    "student": 25.35546443570249
  },
  "chg": -0.09492438166815431,
  "ridge_kv_both_score_mean": 0.7623138478778037,
