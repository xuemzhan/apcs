...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-08-29T20:05:56.104338
...
```json
{
  ...
  "method_stats": {
    "ridge_kv_both": {
      "total": 30,
      "accuracy": 0.2,
      "gold_prob_mean": 0.1995621067119897,
      "conf_mean": 0.7424413209465758,
      "ppl_mean": 65.05674925348967,
      "logit_cos_mean": 0.5156985865635613
    },
    "ridge_native": {
      "total": 30,
  ...
  "chg_gold": {
    "ridge_kv_both": {
      "mean": -0.3033968296526338,
      "ci_low": -0.4535600641555416,
      "ci_high": -0.1428433740464017,
      "p": 1.0,
      "n": 30,
      "tgrr": -1.5928776376802796
    },
    "ridge_native": {
  ...
  "psr": {
    "mean": -6.273188610421397,
    "median": -6.153341654300115,
    "n": 30,
  ...
  "method_means": {
    "ridge_kv_both": 0.7424413209465758,
  ...
  "ppl_means": {
    "ridge_kv_both": 65.05674925348967,
    "ridge_native": 536082.490463978,
    "ridge_self_kv": 21.226648495205207,
    "student": 25.35546443570249
  },
  "chg": -0.11479690859938219,
  "ridge_kv_both_score_mean": 0.7424413209465758,
