...
- **能力 Gate（gold 口径）**: FAIL（ridge_kv_both: chg=-0.22370424674730413, ci_low=-0.3335913903675412, p=1.0）
- **PSR**: mean=-4.863, median=-4.616（n=100，含测量开销偏保守）
...
| ridge_kv_both | 0.270 | 0.2879 | 0.7618 | 146.93 |
| summary | 0.440 | 0.4036 | 0.7787 | - |

## CHG（gold 口径，ridge_kv_both − student）

- mean=-0.2237, 95% CI=[-0.3336, -0.1174], p=1.0000, TGRR=-1.249