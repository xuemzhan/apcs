...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-08-29T14:56:58.472253
...
```json
{
  ...
  "method_stats": {
    "ridge_k_only": {
      "total": 30,
      "accuracy": 0.3,
      "gold_prob_mean": 0.28004755584458113,
      "conf_mean": 0.7410688256344158,
      "ppl_mean": 227.98085856042474,
      "logit_cos_mean": 0.5049702683686297
    },
    "ridge_kv_both": {
      "total": 30,
      "accuracy": 0.36666666666666664,
      "gold_prob_mean": 0.32953206643535776,
      "conf_mean": 0.7125965777293122,
      "ppl_mean": 47.81335320983826,
      "logit_cos_mean": 0.47618157612677603
    },
    "ridge_native": {
      "total": 30,
      "accuracy": 0.16666666666666666,
      "gold_prob_mean": 0.17115223997738443,
      "conf_mean": 0.6893475945439782,
      "ppl_mean": 535604.8316819452,
      "logit_cos_mean": 0.3508699576700617
    },
    "ridge_self_kv": {
      "total": 30,
      "accuracy": 0.5,
  ...
  "chg_gold": {
    "ridge_k_only": {
      "mean": -0.22291138052004233,
      "ci_low": -0.39328318170178633,
      "ci_high": -0.059898596218500647,
      "p": 0.988011988011988,
      "n": 30,
      "tgrr": -1.1703172825548096
    },
    "ridge_kv_both": {
      "mean": -0.17342686992926587,
      "ci_low": -0.36314531090590574,
      "ci_high": 0.007174540485974037,
      "p": 0.965034965034965,
      "n": 30,
      "tgrr": -0.9105163794872106
    },
    "ridge_native": {
      "mean": -0.331806696387239,
      "ci_low": -0.5064258392273139,
      "ci_high": -0.15269118453612568,
      "p": 0.998001998001998,
      "n": 30,
      "tgrr": -1.7420335845728068
    },
    "ridge_self_kv": {
  ...
  "psr": {
    "mean": -10.813230488104967,
    "median": -10.267876759583796,
    "n": 30,
  ...
  "method_means": {
    "ridge_k_only": 0.7410688256344158,
    "ridge_kv_both": 0.7125965777293122,
    "ridge_native": 0.6893475945439782,
  ...
  "ppl_means": {
    "ridge_k_only": 227.98085856042474,
    "ridge_kv_both": 47.81335320983826,
    "ridge_native": 535604.8316819452,
    "ridge_self_kv": 21.226648495205207,
    "ridge_v_only": 14557744.630471429,
    "student": 25.35546443570249
  },
  "chg": -0.1446416518166458,
  "ridge_kv_both_score_mean": 0.7125965777293122,
