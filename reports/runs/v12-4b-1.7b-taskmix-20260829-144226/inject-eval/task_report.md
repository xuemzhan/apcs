...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-08-29T14:46:16.939884
...
```json
{
  ...
  "method_stats": {
    "ridge_kv_both": {
      ...
      "gold_prob_mean": 0.2043726140503691,
      "conf_mean": 0.6790059659474096,
      "ppl_mean": 105.97630722257423,
      "logit_cos_mean": 0.5084483311220914
    },
    "ridge_native": {
      "total": 30,
  ...
  "chg_gold": {
    "ridge_kv_both": {
      "mean": -0.2985863223142544,
      "ci_low": -0.4667736046367416,
      "ci_high": -0.13310432159742974,
      "p": 1.0,
      "n": 30,
      "tgrr": -1.5676217720406338
    },
    "ridge_native": {
  ...
  "psr": {
    "mean": -3.777761615164253,
    "median": -3.562917658516869,
    "n": 30,
  ...
  "method_means": {
    "ridge_kv_both": 0.6790059659474096,
  ...
  "ppl_means": {
    "ridge_kv_both": 105.97630722257423,
    "ridge_native": 536082.490463978,
    "ridge_self_kv": 21.226648495205207,
    "student": 25.35546443570249
  },
  "chg": -0.17823226359854838,
  "ridge_kv_both_score_mean": 0.6790059659474096,
