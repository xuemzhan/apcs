...
- **能力 Gate（gold 口径）**: FAIL（ridge_kv_both: chg=-0.2361556448519745, ci_low=-0.351553274631589, p=1.0）
- **PSR**: mean=-9.715, median=-9.812（n=63，含测量开销偏保守）
...
| ridge_kv_both | 0.206 | 0.2606 | 0.6872 | 140.00 |

## CHG（gold 口径，ridge_kv_both − student）

- mean=-0.2362, 95% CI=[-0.3516, -0.1255], p=1.0000, TGRR=-1.324