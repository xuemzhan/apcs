...
- TASK_ID: `inject-eval`
- STATUS: **FAIL**
- Generated at: 2026-08-29T14:34:20.168798
...
```json
{
  ...
  "method_stats": {
    "ridge_kv_both": {
      ...
      "gold_prob_mean": 0.19696480892909,
      "conf_mean": 0.7841136858895991,
      "ppl_mean": 18742.549631974598,
      "logit_cos_mean": 0.43075867261467693
    },
    "ridge_native": {
      "total": 30,
      "accuracy": 0.23333333333333334,
  ...
  "chg_gold": {
    "ridge_kv_both": {
      "mean": -0.30599412743553356,
      "ci_low": -0.47319357569463477,
      "ci_high": -0.12911706003464046,
      "p": 1.0,
      "n": 30,
      "tgrr": -1.6065138301267012
    },
    "ridge_native": {},
    "ridge_self_kv": {
  ...
  "psr": {
    "mean": -3.495952179881107,
    "median": -3.4387395023097866,
    "n": 30,
  ...
  "method_means": {
    "ridge_kv_both": 0.7841136858895991,
    "ridge_native": 0.0,
  ...
  "ppl_means": {
    "ridge_kv_both": 18742.549631974598,
    "ridge_self_kv": 21.226648495205207,
    "student": 25.35546443570249
  },
  "chg": -0.0731245436563589,
  "ridge_kv_both_score_mean": 0.7841136858895991,
