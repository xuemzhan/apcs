...
- TASK_ID: `inject-eval`
- STATUS: **PASS**
- Generated at: 2026-08-29T14:08:56.689379
...
```json
{
  ...
  "method_stats": {
    "ridge_k_only": {
      "total": 30,
      "accuracy": 0.3,
      "gold_prob_mean": 0.22652028873118998,
      "conf_mean": 0.6942986589210424,
      "ppl_mean": 252.78373844575614,
      "logit_cos_mean": 0.5195229093685907
    },
    "ridge_kv_both": {
      "total": 30,
      "accuracy": 0.2,
    ...
    "ridge_v_only": {
      ...
      "gold_prob_mean": 0.33637328166321473,
      "conf_mean": 0.8639891844542136,
      "ppl_mean": 18475598.0575336,
      "logit_cos_mean": 0.05229688742595174
    },
    "student": {
      "total": 30,
      "accuracy": 0.5,
  ...
  "chg_gold": {
    "ridge_k_only": {
      "mean": -0.27643864763343345,
      "ci_low": -0.4437212539143566,
      "ci_high": -0.1098441694396351,
      "p": 0.996003996003996,
      "n": 30,
      "tgrr": -1.4513432474229286
    },
    "ridge_kv_both": {
    ...
    "ridge_v_only": {
      "mean": -0.1665856547014087,
      "ci_low": -0.3738533790989176,
      "ci_high": 0.046567396573291155,
      "p": 0.9210789210789211,
      "n": 30,
      "tgrr": -0.8745990010377128
    }
  },
  "chg_accuracy": {
    "ridge_k_only": {
