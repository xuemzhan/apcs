...
- **能力 Gate（gold 口径）**: FAIL（ridge_kv_both: chg=-0.2206562444283431, ci_low=-0.3400993934150115, p=1.0）
- **PSR**: mean=-3.104, median=-2.859（n=63，含测量开销偏保守）
...
| ridge_kv_both | 0.238 | 0.2761 | 0.5737 | 1008.15 |

## CHG（gold 口径，ridge_kv_both − student）

- mean=-0.2207, 95% CI=[-0.3401, -0.1038], p=1.0000, TGRR=-1.237