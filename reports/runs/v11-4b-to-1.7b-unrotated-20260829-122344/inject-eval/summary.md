...
- **能力 Gate（gold 口径）**: FAIL（ridge_kv_both: chg=-0.16495601869485005, ci_low=-0.3880527468138552, p=0.9080919080919081）
- **PSR**: mean=-14.608, median=-14.045（n=20，含测量开销偏保守）
...
| ridge_kv_both | 0.250 | 0.2562 | 0.6801 | 226.92 |

## CHG（gold 口径，ridge_kv_both − student）

- mean=-0.1650, 95% CI=[-0.3881, +0.0648], p=0.9081, TGRR=-0.796