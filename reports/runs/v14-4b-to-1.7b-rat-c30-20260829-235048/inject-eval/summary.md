...
- **能力 Gate（gold 口径）**: FAIL（ridge_kv_both: chg=-0.26820207751483777, ci_low=-0.4397549627955815, p=0.996003996003996）
- **PSR**: mean=-3.546, median=-3.230（n=30，含测量开销偏保守）
...
| ridge_kv_both | 0.233 | 0.2348 | 0.5465 | 501.56 |

## CHG（gold 口径，ridge_kv_both − student）

- mean=-0.2682, 95% CI=[-0.4398, -0.0918], p=0.9960, TGRR=-1.408