...
spans $-0.14$ to $-0.30$ against a self-kv control at $+0.000$. Calibration
...
change over the student's own prefill spans $-0.14$ to $-0.30$ (best and
...
also fails: CHG $-0.265$ $[-0.426, -0.111]$ with accuracy $0.233$, even though
it reconstructs a fluent cache (PPL $31.6$ versus $25.4$ for the student). The strong student never
...
share. The mapper-ladder results use a single seed per configuration. Because the
