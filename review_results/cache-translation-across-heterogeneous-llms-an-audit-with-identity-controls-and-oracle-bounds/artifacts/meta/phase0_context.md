...
**File**: `/workspace/apcs/paper/cache_audit/main.tex` | **Language**: en | **Mode**: quick-audit
**Generated**: 2026-08-29T21:06:27.421072

## Issue Summary (179 total)
- Major: 5
- Minor: 174
...
|---|------|----------|----------|-------|
| 1 | — | Minor | P2 | Check: /workspace/apcs/paper/cache_audit/main.tex |
| 2 | — | Minor | P2 | PASS |
...
| # | Line | Severity | Priority | Issue |
|---|------|----------|----------|-------|
| 1 | 478 | Major | P1 | Performance claim lacks an explicit baseline or comparator. |
| 2 | 419 | Minor | P2 | No ablation or component-level evidence is mentioned; verify that contribution attribution is covered. |
| 3 | 570 | Major | P1 | Discussion may lack depth: low ratio of explanatory/attribution language (0/23 lines). Add causal analysis explaining why results occur. |
| 4 | 570 | Major | P1 | Discussion may lack layered structure: it should cover at least two categories (mechanism, comparison with prior work, limitations/boundaries, implications/outlook) instead of only restating results. |
| 5 | 640 | Major | P1 | Conclusion lacks limitations or future work discussion. |
| 6 | 640 | Minor | P2 | Conclusion lacks implications or broader impact statement. |
| 7 | 640 | Minor | P2 | Conclusion lacks explicit summary of core findings. |

### FIGURES

| # | Line | Severity | Priority | Issue |
|---|------|----------|----------|-------|
| 1 | — | Minor | P2 | figures in /workspace/apcs/paper/cache_audit/main.tex... |
| 2 | — | Minor | P2 | 3 figures. |
| 3 | — | Minor | P2 | Line 434: figures/fig2_mapper_landscape.pdf |
| 4 | — | Minor | P2 | Line 513: figures/fig3_oracle_probes.pdf |
| 5 | — | Minor | P2 | Line 543: figures/fig4_ppl_acc_decoupling.pdf |
...
| 3 | — | Minor | P2 | ============================================================ |
| 4 | — | Minor | P2 | /workspace/apcs/paper/cache_audit/main.tex |
...
| 2 | 36 | Minor | P2 | [G2] Long paragraph detected (280 words, 12 sentences); split or add a clearer topic sentence. |
| 3 | 140 | Minor | P2 | [G2] Long paragraph detected (394 words, 2 sentences); split or add a clearer topic sentence. |
| 4 | 216 | Minor | P2 | [G2] Long paragraph detected (198 words, 9 sentences); split or add a clearer topic sentence. |
| 5 | 369 | Minor | P2 | [G2] Long paragraph detected (239 words, 9 sentences); split or add a clearer topic sentence. |
| 6 | 476 | Minor | P2 | [G2] Long paragraph detected (195 words, 10 sentences); split or add a clearer topic sentence. |
| 7 | 380 | Minor | P2 | [L4] Numbered equation environment has no label for later reference. |

### REFERENCES

| # | Line | Severity | Priority | Issue |
|---|------|----------|----------|-------|
| 1 | 104 | Minor | P2 | Reference before definition: \ref{fig:framework} at line 104 appears before label definition at line 193 |
| 2 | 200 | Minor | P2 | Reference before definition: \ref{tab:related} at line 200 appears before label definition at line 288 |
...
|---|------|----------|----------|-------|
| 1 | — | Minor | P2 | [Script]: goal=grammar strength=minimal |
| 2 | — | Minor | P2 | SENTENCE (Line 69, 37 words, 6 clauses)  [Script] |
...
| 10 | — | Minor | P2 | SENTENCE (Line 124, 31 words, 4 clauses)  [Script] |
...
| 18 | — | Minor | P2 | SENTENCE (Line 124, 34 words, 4 clauses)  [Script] |
...
| 26 | — | Minor | P2 | SENTENCE (Line 140, 369 words, 47 clauses)  [Script] |
...
| 34 | — | Minor | P2 | SENTENCE (Line 351, 41 words, 5 clauses)  [Script] |
...
| 42 | — | Minor | P2 | SENTENCE (Line 358, 45 words, 4 clauses)  [Script] |
...
| 50 | — | Minor | P2 | SENTENCE (Line 369, 86 words, 12 clauses)  [Script] |
...
| 58 | — | Minor | P2 | SENTENCE (Line 412, 25 words, 4 clauses)  [Script] |
...
| 66 | — | Minor | P2 | SENTENCE (Line 412, 11 words, 4 clauses)  [Script] |
...
| 74 | — | Minor | P2 | SENTENCE (Line 422, 24 words, 4 clauses)  [Script] |
...
| 82 | — | Minor | P2 | SENTENCE (Line 452, 174 words, 24 clauses)  [Script] |
...
| 90 | — | Minor | P2 | SENTENCE (Line 476, 47 words, 4 clauses)  [Script] |
...
| 98 | — | Minor | P2 | SENTENCE (Line 476, 30 words, 5 clauses)  [Script] |
| 99 | — | Minor | P2 | Third, structure and function class change little: per-layer merging ( ), task-aware fine-tuning ( ), RAT (  to  ), and a per-head MLP mapper with two GELU layers (  at  , at  ) all sit inside the same band. |
| 100 | — | Minor | P2 | Third. structure and function class change little: per-layer merging ( ). task-aware fine-tuning ( ). RAT (  to  ). and a per-head MLP mapper with two GELU layers (  at. at  ) all sit inside the same band.. |
...
| 106 | — | Minor | P2 | SENTENCE (Line 552, 24 words, 4 clauses)  [Script] |
...
| 114 | — | Minor | P2 | SENTENCE (Line 573, 41 words, 5 clauses)  [Script] |
...
| 122 | — | Minor | P2 | SENTENCE (Line 573, 43 words, 5 clauses)  [Script] |
...
| 130 | — | Minor | P2 | SENTENCE (Line 36, 50 words, 8 clauses)  [Script] |
| 131 | — | Minor | P2 | Across six mapper families (per-head ridge, affine, per-layer affine, task-aware, a residual-anchored translator, and a per-head MLP), a controlled calibration ladder on a fixed evaluation set, and 28 recorded GPU runs, no configuration makes the strong student exceed its own prefill: gold-probability change spans   to   against a self-kv control at  . |
| 132 | — | Minor | P2 | Across six mapper families (per-head ridge. affine. per-layer affine. task-aware. a residual-anchored translator. and a per-head MLP). a controlled calibration ladder on a fixed evaluation set. and 28 recorded GPU runs. no configuration makes the strong student exceed its own prefill: gold-probability change spans   to   against a self-kv control at  .. |
...
- [ ] Acronyms defined on first use — Potentially undefined: ['LSC', 'RAG', 'QA', 'GELU', 'FFN']
