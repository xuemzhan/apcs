...
| Line | Severity | Issue |
|------|----------|-------|
| --- | Minor | Check: /workspace/apcs/paper/cache_audit/arxiv/main.tex |
| --- | Minor | PASS |
| --- | Minor | entries: 0 |
| --- | Minor | entries: 0 |
...
| Line | Severity | Issue |
|------|----------|-------|
| 473 | Major | Performance claim lacks an explicit baseline or comparator. |
| 414 | Minor | No ablation or component-level evidence is mentioned; verify that contribution attribution is covered. |
| 414 | Minor | No statistical significance, variance, or confidence information is mentioned. |
| 559 | Major | Discussion may lack depth: low ratio of explanatory/attribution language (0/23 lines). Add causal analysis explaining why results occur. |
| 559 | Major | Discussion may lack layered structure: it should cover at least two categories (mechanism, comparison with prior work, limitations/boundaries, implications/outlook) instead of only restating results. |
| 627 | Major | Conclusion lacks limitations or future work discussion. |
| 627 | Minor | Conclusion lacks implications or broader impact statement. |
| 627 | Minor | Conclusion lacks explicit summary of core findings. |

### [Script] FIGURES

| Line | Severity | Issue |
|------|----------|-------|
| --- | Minor | figures in /workspace/apcs/paper/cache_audit/arxiv/main.tex... |
| --- | Minor | 3 figures. |
| --- | Minor | Line 429: figures/fig2_mapper_landscape.pdf |
| --- | Minor | Line 506: figures/fig3_oracle_probes.pdf |
| --- | Minor | Line 532: figures/fig4_ppl_acc_decoupling.pdf |
...
| --- | Minor | ============================================================ |
| --- | Minor | /workspace/apcs/paper/cache_audit/arxiv/main.tex |
| --- | Minor | UNAVAILABLE |
...
| 36 | Minor | [G2] Long paragraph detected (257 words, 11 sentences); split or add a clearer topic sentence. |
| 138 | Minor | [G2] Long paragraph detected (394 words, 2 sentences); split or add a clearer topic sentence. |
| 214 | Minor | [G2] Long paragraph detected (198 words, 9 sentences); split or add a clearer topic sentence. |
| 365 | Minor | [G2] Long paragraph detected (239 words, 9 sentences); split or add a clearer topic sentence. |
| 562 | Minor | [G2] Long paragraph detected (223 words, 10 sentences); split or add a clearer topic sentence. |
| 376 | Minor | [L4] Numbered equation environment has no label for later reference. |

### [Script] REFERENCES

| Line | Severity | Issue |
|------|----------|-------|
| 102 | Minor | Reference before definition: \ref{fig:framework} at line 102 appears before label definition at line 191 |
| 198 | Minor | Reference before definition: \ref{tab:related} at line 198 appears before label definition at line 286 |
...
|------|----------|-------|
| --- | Minor | [Script]: goal=grammar strength=minimal |
| --- | Minor | SENTENCE (Line 67, 37 words, 6 clauses)  [Script] |
...
| --- | Minor | SENTENCE (Line 122, 31 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 122, 34 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 138, 369 words, 47 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 347, 41 words, 5 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 354, 45 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 365, 86 words, 12 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 407, 25 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 407, 11 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 417, 24 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 447, 174 words, 24 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 471, 47 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 471, 17 words, 4 clauses)  [Script] |
| --- | Minor | Third, structure changes little: per-layer merging ( ), task-aware fine-tuning ( ), and RAT (  at  , at  ) sit inside the same band. |
| --- | Minor | Third. structure changes little: per-layer merging ( ). task-aware fine-tuning ( ). and RAT (  at. at  ) sit inside the same band.. |
| --- | Minor | Sentence exceeds complexity threshold, split for readability. Applying the split needs --strength moderate or higher. |
| --- | Minor | none (split proposal only; source not rewritten) |
| --- | Minor | none |
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 541, 24 words, 4 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 562, 41 words, 5 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 562, 43 words, 5 clauses)  [Script] |
...
| --- | Minor | Check: NEEDS-LLM |
| --- | Minor | Flags:    not-assessed |
| --- | Minor | SENTENCE (Line 36, 49 words, 7 clauses)  [Script] |
| --- | Minor | Across five mapper families (per-head ridge, affine, per-layer affine, task-aware, and a residual-anchored translator built from the two models' own projections), a 200-example calibration ladder, and 21 recorded GPU runs, no configuration makes the strong student exceed its own prefill: gold-probability change spans   to   against a self-kv control at  . |
| --- | Minor | Across five mapper families (per-head ridge. affine. per-layer affine. task-aware. and a residual-anchored translator built from the two models' own projections). a 200-example calibration ladder. and 21 recorded GPU runs. no configuration makes the strong student exceed its own prefill: gold-probability change spans   to   against a self-kv control at  .. |
| --- | Minor | Sentence exceeds complexity threshold, split for readability. Applying the split needs --strength moderate or higher. |
| --- | Minor | none (split proposal only; source not rewritten) |
| --- | Minor | none |
